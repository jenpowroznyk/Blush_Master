Shader "GrassFlow/Grass Material Shader With Depth&Add Passes" {
	Properties {
		[Space(15)]
	...
	SubShader{
		...
		pass {
			...
			//having this defined breaks my code a bit and doesnt make sense to be defined in the forward add pass
			//not sure why multi_compile_fwdadd_fullshadows even adds this keyword
			#undef SHADOWS_DEPTH
