...
namespace GrassFlow {
    public class TextureCreator : MonoBehaviour {
        ...
        public static void CreateColorMap(Texture2D inTex, int width = 128, int height = 128, float noiseScale = 10f, float normalization = 0.6f) {
            ...
            for (int y = 0; y < height; y++) {
                for (int x = 0; x < width; x++) {
                    ...
                    float pNoise = Mathf.PerlinNoise(u * noiseScale, v * noiseScale) * normMult + normalization;

                    pixels[width * y + x] = Color.white * pNoise;
                }
            }
        ...
        public static RenderTexture GetTerrainNormalMap(Terrain terrainObj, ComputeShader normalShader, int normalKernel, bool highQuality) {
